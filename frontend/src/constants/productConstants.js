export const allProductRequest ="All Prouct Request";
export const allProductSuccess ="All Product Fetch Success";
export const allProductError ="Error in Product fetching";
...
export const productDetailRequest ="Product Detail Request";
export const productDetailSuccess ="Product Detail Success";
export const productDetailError ="Error in Product Detail";
